"""
Django settings for Fordham SwipeShare project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-sq5b(h)-730qz!mcdix$aq_0sod#zft6!d0@_l$-=#-&obqg6x')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1').split(',')
ALLOWED_HOSTS += ['swipeshare-production.up.railway.app', '.railway.app']
...
LANGUAGE_CODE = 'en-us'
TIME_ZONE = 'America/New_York'  # Fordham is in Eastern Time
USE_I18N = True
USE_TZ = True
...
# For production email (Gmail, SendGrid, etc.)
...
ALLOWED_EMAIL_DOMAIN = config('ALLOWED_EMAIL_DOMAIN', default='@fordham.edu')
